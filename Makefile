...
# aruba.it/clusterupgrade-operator-bundle:$VERSION and aruba.it/clusterupgrade-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= fedecerruto/clusterupgrade-operator
